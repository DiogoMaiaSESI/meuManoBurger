        ...
        <aside class="sidebar">
            ...
            <nav class="sidebar-nav">
                <ul>
                    ...
                    <li><a href="pedidosUSER.php" id="btn-historico" class="nav-link">Histórico de Pedidos</a></li>
                    ...
                    <div class="form-group">
                        ...
                        <div class="brand-selector">
                            <button type="button" class="brand-btn" data-brand="visa">
                                <img src="/templates/assets/img/Visa.webp" alt="Visa">
                            </button>
                            <button type="button" class="brand-btn" data-brand="mastercard">
                                <img src="/templates/assets/img/Mastercard.webp" alt="Mastercard">
                            </button>
                        </div>

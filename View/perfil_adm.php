...
require_once "$root/meuManoBurger/vendor/autoload.php";
require_once "$root/meuManoBurger/Controller/AdmController.php";
require_once "$root/meuManoBurger/Model/Adm.php";
